...
HRESULT InitRenderer(HINSTANCE hInstance, HWND hWnd, BOOL bWindow)
{
	...
	g_D3DDevice->CreateRenderTargetView( pBackBuffer, NULL, &g_RenderTargetView );//ここで統合
...
{   
	// バックバッファクリア
	float ClearColor[4] = { GUI::GetBackColor()[0],GUI::GetBackColor()[1],GUI::GetBackColor()[2],GUI::GetBackColor()[3] };
